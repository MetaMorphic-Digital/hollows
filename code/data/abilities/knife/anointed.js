...
import { getActiveEntityActor, getActorZone, isCloseZone } from "../../../canvas/zone.js";
...
export const ANOINTED = new EndOfTurnAction({
  ...
  when: ({ actor }) => isCloseZone(getActorZone(actor)) && getActiveEntityActor()?.statuses.has("bleeding"),
  effects: [
