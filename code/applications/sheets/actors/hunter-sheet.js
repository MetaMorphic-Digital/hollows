...
import { openUseForActor, hasActiveUseOptions } from "../../../data/actions/use.js";
...
import { hasCondition, addCondition, removeCondition, setConditionSafe } from "../../../documents/actor/conditions.js";
...
import { postEffectTextChat, runEffectGroups, relicHasActiveUse } from "../../../data/relic/apply-effect.js";
import {
  getEchoPacks, hasEchoRollContent,
  rollEchoFlow, addEchoById, applySeedEchoEffect
...
import { isNewHunterActor, openCharacterCreationWizard } from "../../apps/character-creation.js";
...
import { getAttackRollMode, runOnAttackResult, activateAbility, getActivatedAbilities, getStatOverrides, tryActivateStatOverride, evaluateStatOverrideSuccess } from "../../../helpers/weapon-abilities/dispatchers.js";
...
export class HollowsHunterSheet extends HandlebarsApplicationMixin(ActorSheetV2) {
